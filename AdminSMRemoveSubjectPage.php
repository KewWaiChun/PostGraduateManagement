<?php
  ...
  $sub="SELECT DISTINCT Subject_ID FROM subject";
  $getSub=$conn->query($sub);
  function displaySubjectList(){
    while ($row = $GLOBALS['getSub']->fetch_assoc()){
      $sub = $row['Subject_ID'];
    ...
    <div class="container">
          ...
          <ul class="nav nav-justified">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                ...
                <li class="active"><a href="AdminSMRemoveSubjectPage.php">Remove Subject</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <a id="dLabel" role="button" data-toggle="dropdown" class="btn btn-primary" data-target="#" href="#">
      ...
      <div>
        <div class="managementBox">
          <table>
            <form action="AdminSMRemoveChooseSubject.php" method="post">
