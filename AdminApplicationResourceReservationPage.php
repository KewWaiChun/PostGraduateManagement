AdminApplicationAnnouncementPage<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <title>Admin Application Resource Reservation Page</title>
          ...
          <ul class="nav nav-justified">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                <li class="active"><a href="AdminApplicationReservationPage.php">Resource Reservation</a></li>
      ...
      <div>
         <div class="hotel_reserve_box">
           <h3 style="text-align: center"> Resources Reservation</h3><br>
            <form form id="AdminReservetab" action="AdminreserveSubmit.php" enctype="multipart/form-data" method="POST">
              ...
              Date:<input type="text" name="Date" placeholder="yyyy-mm-dd"><br>
      				...
      				<div>
					<textarea rows="4" cols="50" name="RePurpose" placeholder="(In 255 words...)"></textarea>
				</div>
         <div class="form-group">
