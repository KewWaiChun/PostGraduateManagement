...
<html lang="en">
  <head>
    ...
    <title>Student CSWEdit Profile Page</title>
      ...
      <div class="masthead">
        <nav><!-- navigation bar -->
          <ul class="nav nav-justified">
            ...
            <li class="active"><a href="StudentCSWProfilePage.php">Profile</a></li>
            <li><a href="index.html">Log Out</a></li>
          </ul>
        </nav>
      </div><!-- masthead -->

      <!-- custom design for Student to edit profile -->
      <div class="row">
      <br>
            ...
            <div class="panel-body">
              <div class="row">
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <form action="StudentUpdateProfile.php" method="post">
                    <table class="table table-user-information">
                      <tbody>
                        ...
                        <tr>
                          <td><b>Total Credit Hour</b></td>
                          <td><?php echo $studentTotalCreditHour;?></td>
                        </tr>
                        <tr>
                          <td><b>Contact</b></td>
                          <td>
