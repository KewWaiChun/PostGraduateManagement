...
<html lang="en">
  <head>
    ...
    <title>Supervisor Profile Page</title>
                ...
                <div class=" col-md-9 col-lg-9 "> 
                  <table class="table table-user-information">
                    <tbody>
                      ...
                      <tr>
                        <td><b>Contact</b></td>
                        <td><?php echo $supervisorContact;?></td>
                      </tr>
                      <tr>
                        <td><b>Email</b></td>
                        <td><?php echo $supervisorEmail;?></td>
                      </tr>
                    </tbody>
                  </table>
                  <a href="SupervisorEditProfilePage.php" class="btn btn-primary">Edit Profile</a>
                </div>
              </div>
            </div>
          </div>
