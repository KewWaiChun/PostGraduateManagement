...
<html lang="en">
  <head>
    ...
    <title>Student CSW Financial Page</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="masthead">
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="active"><a href="StudentCSWFinancialPage.php">Finance</a></li>
      ...
      <div class="payment">
        ...
        <hr>
        <form id="paymenttab" action="FinanceSubmit.php" method="Post">
