...
<html lang="en">
  <head>
    ...
    <title>Student R Application Resource Page</title>
    ...
    <div class="container">
          ...
          <ul class="nav nav-justified">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                <li class="active"><a href="StudentRApplicationResourcePage.php">Resource Reservation</a></li>
      ...
      <div>
         <div class="hotel_reserve_box">
           ...
           <form id="Reservetab" action="RreserveSubmit.php" enctype="multipart/form-data" method="POST">
