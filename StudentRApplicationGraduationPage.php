...
<html lang="en">
  <head>
    ...
    <title>Student R Application Graduation Page</title>
    ...
    <div class="container">
          ...
          <ul class="nav nav-justified">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                ...
                <li class="active"><a href="StudentRApplicationGraduationPage.php">Graduation</a></li>
              </ul>
            </li>
      ...
      <div>
        <div class="hotel_reserve_box">
		  ...
		  ?>
		  <form id="Gradtab" action="RGradSubmit.php" method="post">
