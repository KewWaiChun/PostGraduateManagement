...
//get admmin ID from index when login successful
      ...
      <div class="masthead">
        <nav><!--navigation Bar -->
          <ul class="nav nav-justified">
            ...
            <li class="active"><a href="AdminProfilePage.php">Profile</a></li>
            <li><a href="index.html">Log out</a></li>
          </ul>
        </nav>
      </div><!-- masthead -->

      <!-- custim design for admin to edit profile -->
      <div class="row">
      <br>
                    ...
                    <table class="table table-user-information">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              <input type="text" placeholder="FCI" name="department"br>
                          </td>
                        </tr>
                        <tr>
                          <td><b>Contact</b></td>
